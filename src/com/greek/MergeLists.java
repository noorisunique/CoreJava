...
class MergeLists {
	...
	public static void main(String args[]) {
		/*
		 * Let us create two sorted linked lists to test the methods Created
		 * lists: llist1: 5->10->15, llist2: 2->3->20
		 */
...
class Gfg {
	...
	Node sortedMerge(Node headA, Node headB) {
		...
		while (true) {
			 ...
			 * smaller, append it into tail and advance the head to the next
			 * Node
			 */
